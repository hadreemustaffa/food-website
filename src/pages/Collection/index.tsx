  ...
  return (
    <div className='col-span-full flex flex-col gap-4'>
      <div className='flex flex-row flex-wrap justify-between'>
        ...
        <Button variant='primary' value='Delete All Recipes' onClick={handleDeleteAllRecipes} />
      </div>
        ...
        <ul className='grid gap-4 sm:grid-cols-auto-fill-225'>
          {recipes.map((recipe) => (
            <li key={recipe.id} className='flex flex-col gap-4'>
              ...
              <Button variant='secondary' value='Delete Recipe' onClick={() => handleDeleteRecipe(recipe.id)} />
            </li>
          ))}
        </ul>
      ) : (
