  ...
  return (
    <>
      <div className='relative col-span-full flex flex-col gap-6 overflow-hidden rounded-sm shadow-black-100 sm:shadow-sm'>
        <picture>
          <source media='(min-width: 576px)' srcSet='./hero-image-laptop.jpg' type='image/jpg' />
          <source media='(min-width: 1248px)' srcSet='./hero-image-desktop.jpg' type='image/jpg' />
          <img className='aspect-video object-cover' src='./hero-image-mobile.jpg' alt='' />
        </picture>
