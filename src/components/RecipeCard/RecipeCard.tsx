...
export const RecipeCardDetailed = ({
  ...
  return (
    <Link
      to={`/recipe/${id}`}
      className='flex flex-col overflow-hidden rounded-sm border-2 border-black-950 bg-black-950 text-left text-white shadow-sm shadow-black-100 sm:flex-row'
    >
...
export const RecipeCardMinimal = ({
  ...
  return (
    <Link
      to={`/recipe/${id}`}
      className='flex h-full flex-col overflow-hidden rounded-sm border-2 border-black-950 bg-black-950 text-left text-white shadow-sm shadow-black-100 xs:flex-row sm:flex-col'
    >
